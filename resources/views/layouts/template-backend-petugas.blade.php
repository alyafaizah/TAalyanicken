				...
				<div id="kt_header" class="header bg-white header-fixed">
					...
					<div class="container-fluid d-flex align-items-stretch justify-content-between">
						...
						<div class="d-flex align-items-stretch mr-2">
							<!--begin::Page Title-->
							<h3 class="d-none text-dark d-lg-flex align-items-center mr-10 mb-0">Petugas Tiket</h3>
							<!--end::Page Title-->
		...
		<div class="offcanvas-content pr-5 mr-n5">
			...
			<div class="d-flex align-items-center mt-5">
				<div class="symbol symbol-100 mr-5">
					<div class="symbol-label" style="background-image:url('https://cdn.dribbble.com/users/5454230/screenshots/12344248/media/b87b7ea552b1c954d59e192bbd5fdedf.gif')"></div>
			...
			<div class="navi navi-spacer-x-0 p-0">
				<!--begin::Item-->
				<a href="/petugas/order" class="navi-item">
					<div class="navi-link">
						...
						<div class="navi-text">
							<div class="font-weight-bold">Transaksi Baru</div>
				...
				<!--begin::Item-->
				<a href="/riwayatpetugas" class="navi-item">
					<div class="navi-link">
						<div class="symbol symbol-40 bg-light mr-3">
							<div class="symbol-label">

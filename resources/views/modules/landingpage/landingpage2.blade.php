...
<body id="top">
    ...
    <section id="promo" class="s-clients">
    ...
    <section id="contact" class="s-contact">
        ...
        <div class="row section-header" data-aos="fade-up">
            <div class="col-full">
                <h1 class="display-2 display-2--light">Hubungi Kami</h1>
            </div>
        </div>
        <div class="row contact-content" data-aos="fade-up">
            <div class="contact-primary">
                <h3 class="h6 hide-on-fullwidth">Kontak Info</h3>
                <div class="cinfo">
                    <h5>Email Kami</h5>
                    <p> kandangsapiwonosalam@gmail.com</p>
                </div>
                <div class="cinfo">
                    <h5>Telepon</h5>
                    <p>085101305864</p>
                ...
                <div class="cinfo">
                    <h5>Alamat</h5>
                    <p>Jl. Anjasmoro Dsn Tukum, RT.06/RW.04, Notorejo, Wonosalam, Kec. Wonosalam, Kabupaten Jombang, Jawa Timur 61476</p>
                </div>
            </div>
    ...
    {
    return
    '<svg width="550px" height="200px" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 611.492 523.95294" xmlns:xlink="http://www.w3.org/1999/xlink">
    ...
    function weekend()
    {
    return '<svg width="550px" height="200px" xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 1106 783.42853" xmlns:xlink="http://www.w3.org/1999/xlink">

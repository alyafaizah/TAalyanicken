			...
			<div class="d-flex flex-center bgi-size-cover bgi-no-repeat flex-row-fluid" style="background-image: url(assets/media/bg/bg-1.jpg);">
				<div class="login-form text-center text-white p-7 position-relative overflow-hidden">
					...
					<div class="login-signin">
						...
						<form class="form" id="kt_login_signin_form" action="/login/proses" method="post">
					...
					<div class="login-signup">
						<div class="mb-20">
							<h1>Daftar</h1>
							<p class="opacity-60">Masukkan detail Anda untuk membuat akun.</p>
						</div>
						<form class="form text-center" id="kt_login_signup_form" action="/register/proses" method="post">

							@csrf


							<div class="form-group">
								<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="text" placeholder="Nama Lengkap" name="nama_lengkap" />
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Kata Sandi" name="password" />
							</div>
							<div class="form-group">
								<input class="form-control h-auto text-white placeholder-white opacity-70 bg-dark-o-70 rounded-pill border-0 py-4 px-8" type="password" placeholder="Konfirmasi Kata Sandi" name="cpassword" />
							</div>
							<div class="form-group text-left px-8">
								<div class="checkbox-inline">
									<label class="checkbox checkbox-outline checkbox-white text-white m-0">
										...
										<a href="#" class="text-white font-weight-bold ml-1">syarat dan ketentuan</a>.</label>
								</div>
								<div class="form-text text-muted text-center"></div>
							</div>
							<div class="form-group">
								<button type="submit" class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3 m-2">Daftar</button>
								<button id="kt_login_signup_cancel" class="btn btn-pill btn-outline-white font-weight-bold opacity-70 px-15 py-3 m-2">Batal</button>
							</div>
						</form>
					</div>

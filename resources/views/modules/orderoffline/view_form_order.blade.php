                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="kode_order" class="form-control"
                                                    value="{{ $kode_order }}" readonly>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control"
                                                    value="{{ date('d F Y H.i A') }}" readonly>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input name="jenis" class="form-control" value="{{ $jenisTiket }}"
                                                    readonly />
                                            </div>

                        ...
                        <table class="datatable-table" style="display: block;">
                            <thead class="datatable-head">
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <th data-field="" class="datatable-cell datatable-cell-sort datatable-cell-sorted" data-sort="asc"><span style="width: 108px">
                                            #
                                    ...
                                    <th data-field="ShipDate" class="datatable-cell datatable-cell-sort"><span style="width: 108px;text-align:center;">
                                            Tanggal Berkunjung
                                        </span>
                                    </th>
                                    ...
                                    <th data-field="Actions" data-autohide-disabled="false" class="datatable-cell datatable-cell-sort"><span style="width: 125px;">
                                            Actions
                                        </span>
                                    </th>
                                </tr>
                            ...
                            <tbody class="datatable-body" style="">
                                ...
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    ...
                                    <td class="datatable-cell-sorted datatable-cell" data-field="OrderID" aria-label="0023-4383">
                                        <span style="width: 108px;">{{$e+1}}</span>
                                    </td>
                                    ...
                                    <td data-field="CompanyName" aria-label="Witting, Lindgren and Kessler" class="datatable-cell">
                                        <span style="width: 108px;text-align:center;">
                                            {{ date('d M Y H.i A', strtotime($p->tgl_kunjungan)) }}
                                        </span>
                                    </td>

                                                                    ...
                                                                    <div class="pb-5"
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-5 text-center">
                                                                                ...
                                                                                <h5>Weekday</h5>
                                                                                <small>Harga Tiket Mulai dari <code>Senin - Jumat</code></small>
                                                                                <h2>{{ number_format($tiket->weekday, 2) }}</h2>
                                                                            </div>

                                                                            <div class="col-md-5 text-center">
                                                                                @php echo weekend() @endphp
                                                                                <h5>Weekend</h5>
                                                                                <small>Harga Tiket Mulai dari <code>Sabtu - Minggu</code></small>
                                                                                <h2>{{ number_format($tiket->weekend, 2) }}</h2>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        class="form-control"
                                                                                        name="jenis_tiket_interface"
                                                                                        value="weekend" disabled />
                                                                                    <span
                                                                                        class="form-text text-muted">Jenis
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        name="harga" disabled />
                                                                                    <span
                                                                                        class="form-text text-muted">Harga
                                                                                        per
                                                                                        tiket </span>
                                                                                </div>
                                                                                <!--end::Input-->

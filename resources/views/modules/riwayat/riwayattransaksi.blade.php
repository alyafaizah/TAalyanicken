                                ...
                                <table class="datatable-table" style="display: block;">
                                    ...
                                    @foreach ( $pemesanan AS $p )
                                        <tr data-row="0" class="datatable-row" style="left: 0px;">
                                            ...
                                            <td data-field="kd_order" aria-label="64616-103" class="datatable-cell"><span
                                                    style="width: 114px;">{{ $p->kd_order }}</span></td>
                                            <td data-field="status" data-autohide-disabled="false" aria-label="1"
                                                class="datatable-cell"><span style="width: 114px;"><span
                                                        ...
                                                        class="font-weight-bold text-danger">{{ $p->status }}</span></span></td>
                                            <td data-field="tgl_berkunjung" aria-label="64616-103"
                                                class="datatable-cell"><span style="width: 114px;">{{ $p->tgl_kunjungan }}</span></td>
                                            <td data-field="jumlah" aria-label="64616-103"
                                                class="datatable-cell"><span style="width: 114px;">{{ $p->jumlah }}</span></td>
                                            <td data-field="tgl_berkunjung" aria-label="64616-103"

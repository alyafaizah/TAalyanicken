                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>@php
                                                ...
                                                @endphp
                                                <span
                                                    class="label label-light-{{ $color }} label-pill label-inline mr-2">{{ $text }}</span>
                                            </td>
                                            <td>
                                                @if ( $p->status == "diproses" )
                                                <a href="" class="btn btn-primary">Bayar</a>
                                                <a href="javascript:;" data-toggle="modal" data-target="#hapus" class="btn btn-danger">Batalkan</a>
                                                <!-- Modal-->
                                                    ...
                                                    <div class="modal-dialog modal-sm" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href=""
                                                                    class="btn btn-danger font-weight-bold">Hapus
                                                                    Petugas</a>
                                                            </div>
                                                        </div>
                                                    </div>

                            ...
                            <tbody class="datatable-body" style="">
                                ...
                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                    <td class="datatable-cell-center datatable-cell datatable-cell-check"
                                        data-field="RecordID" aria-label="81"><span style="width: 20px;"><label
                                                class="checkbox checkbox-single"><input type="checkbox"
                                                    value="81">&nbsp;<span></span></label></span></td>
                                    <td data-field="OrderID" aria-label="68084-198" class="datatable-cell"><span
                                            style="width: 108px;">{{ $t->kd_tiket }}</span></td>
                                    <td data-field="Country" aria-label="Philippines" class="datatable-cell">
										
										@if ( $t->jenis == "weekend" ) 

											<span style="width: 108px;"><span
                                                class="label font-weight-bold label-lg  label-light-success label-inline">Weekend</span></span>
										@else

											<span style="width: 108px;"><span
                                                class="label font-weight-bold label-lg label-light-warning label-inline">Weekdays</span></span>
										@endif
									</td>

...
<head>
    ...
    <link href="{{ asset('/demo7/distpengunjung/assets/plugins/global/plugins.bundle.css?v=7.2.9') }}" rel="stylesheet"
        type="text/css" />
    <link href="{{ asset('/demo7/distpengunjung/assets/plugins/custom/prismjs/prismjs.bundle.css?v=7.2.9') }}"
        rel="stylesheet" type="text/css" />
    <link href="{{ asset('/demo7/distpengunjung/assets/css/style.bundle.css?v=7.2.9') }}" rel="stylesheet"
        type="text/css" />
                            ...
                            <form class="form" method="post">
                                ...
                                <div class="form-group py-3 border-bottom m-0">
                                    <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="password"
                                        placeholder="Kata Sandi Baru" name="newpasswod" autocomplete="off" />
                                </div>
                                <div class="form-group py-3 border-bottom m-0">
                                    <input class="form-control h-auto border-0 px-0 placeholder-dark-75" type="password"
